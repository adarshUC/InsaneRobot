...
def approve(update, context):
    ...
    message.reply_text(
        f"[{member.user['first_name']}](tg://user?id={member.user['id']}) has been approved in {chat_title}! He/She will now be ignored by automated admin actions like locks, blocklists, and antiflood. Enjoy!",
        parse_mode=ParseMode.MARKDOWN,
    )
    log_message = (
